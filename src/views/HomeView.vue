<template>
  <v-app id="home">
    ...
    <v-container fluid>
        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <h1 class="text-white">Soy J Antonio Tapia C</h1>
              <span class="text-grey">Desarrollador Web Jr.</span><br />
        ...
        <div>
          <v-row>
            ...
            <v-col cols="12" sm="6">
              ...
              <h4 class="mt-n4">Soy Desarrollador Web Jr.</h4>
              <p class="text-grey">
      ...
      <div class="text-center mt-4" id="services">
        <h2>Servicios</h2>
            ...
            <v-col cols="12">
              <div class="child">
                <v-btn
                  ...
                  class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">Diseño Web</h3>
              ...
              <div class="child">
                <v-btn
                  ...
                  class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">Diseño WordPress</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  Lorem, ipsum dolor sit amet <br />consectetur adipisicing
                  <br />consectetur adipis
                </p>
              ...
              <div class="child">
                <v-btn
                  ...
                  class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">Diseño Sitios Web Jr.</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  Lorem, ipsum dolor sit amet <br />consectetur adipisicing
                  <br />consectetur adipis
                </p>
      ...
      <v-col cols="12" sm="12" id="portfolio">
        <div class="d-flex justify-center mb-6">
          ...
          <v-btn class="mr-2" variant="tonal">Diseño con Frontend</v-btn>
          <v-btn class="mr-2" variant="tonal">Diseño WordPress</v-btn>
          <v-btn class="mr-2" variant="tonal">Diseño con Backend</v-btn>
        </div>
      </v-col>
      ...
      <v-col cols="12" sm="12">
        <div class="d-flex justify-center mb-6">
          <v-btn color="#FBDF7E" class="mt-4">Más sitios</v-btn>
        </div>
      </v-col>
          ...
          <v-row>
            <v-col cols="12" sm="4">
              <v-card class="mx-auto" max-width="344" height="">
                ...
                <v-card-title> Te desarrollamos lo mejor </v-card-title>
      ...
      <v-col cols="12" id="biog">
        <div class="hire">
          <v-row>
            <v-col cols="12" sm="8">
              <h1 class="mt-9">Contactame para generar grandes proyectos</h1>
              <p class="text-grey">
            ...
            <v-col cols="12" sm="4">
              <v-btn color="#FBDF7E" class="mt-15">Contratame</v-btn>
            </v-col>
          </v-row>
        </div>
      </v-col>
        ...
        <v-row>
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              ></v-btn
              ><br />
              <span class="text-caption">San Jose del Cabo, Carretera transpenisular </span
              ><br />
              <v-btn
              ...
              ></v-btn
              ><br />
              <span class="text-caption">TapiAnt@gmail.com </span> <br />
              <span class="text-caption">TapiAnt2@gmail.com </span> <br />
            </div>
          </v-col>
          <v-col cols="12" sm="8">
            <h1 class="mt-8">Envianos un mensaje</h1>
            <v-divider></v-divider>
